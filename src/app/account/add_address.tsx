...
} from "@/src/services/shipping-profile.service";
import {
  ShippingProfileReq,
  ShippingProfileDefaultReq,
} from "@/src/types/shipping-profile.type";
import {
  getProvinces,
  getDistricts,
  getWards,
} from "@/src/services/ghn.service";
      ...
      {loading ? (
        ...
        <ScrollView style={styles.content}>
          <Input
            ...
            onChangeText={(text) =>
              setAddress((prev) => ({ ...prev, firstName: text }))
            }
            leftIcon={
          ...
          <Input
            ...
            onChangeText={(text) =>
              setAddress((prev) => ({ ...prev, lastName: text }))
            }
            leftIcon={
              <MaterialCommunityIcons name="account-outline" size={24} />
            }
          ...
          <Input
            ...
            onChangeText={(text) =>
              setAddress((prev) => ({ ...prev, phoneNumber: text }))
            }
          ...
          <View style={styles.containerDefault}>
            ...
            <CustomSwitch
              ...
              onValueChange={() => {
                setAddress((prev) => ({ ...prev, default: !prev.default }));
              }}
            />
          </View>
